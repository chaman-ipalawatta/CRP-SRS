...
if(isset($_POST['btnRegister']))
{
    ...
    if(isset($_SESSION['errors']))
    {
        echo "<script type=\"text/javascript\">window.location = \"edit-model.php?modelid=".$_POST['modelid']."\"</script>";
    }
    ...
    if((!isset($_SESSION['errors']))&&(isset($_POST['btnRegister']))) //If there are no errors we execute this...
    {
        ...
        sql::updateModel($_POST['modelid']);
       
        echo "<script type=\"text/javascript\">window.location = \"models.php?makeid=".$_POST['makeid']."&s=2\"</script>";
