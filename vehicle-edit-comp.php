...
if(isset($_POST['btnRegister']))
{
    ...
    if(isset($_SESSION['errors']))
    {
        echo "<script type=\"text/javascript\">window.location = \"edit-vehicle.php?id=".$_POST['id']."\"</script>";
    }
    ...
    if((!isset($_SESSION['errors']))&&(isset($_POST['btnRegister']))) //If there are no errors we execute this...
    {
        ...
        sql::updateVehicle($_POST['id']);
        echo "<script type=\"text/javascript\">window.location = \"vehicles.php?s=2\"</script>";
