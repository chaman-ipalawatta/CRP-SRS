...
if(isset($_POST['btnRegister']))
{
    ...
    validation::isValidEmail(trim($_POST['email']), 'email', 'Email');
    ...
    if(isset($_SESSION['errors']))
    {
        echo "<script type=\"text/javascript\">window.location = \"add-customers.php\"</script>";
    }
    ...
    if((!isset($_SESSION['errors']))&&(isset($_POST['btnRegister']))) //If there are no errors we execute this...
    {
        ...
        if(sql::saveCustomer() > 0)
        {
            echo "<script type=\"text/javascript\">window.location = \"customers.php?s=1\"</script>";
        }
    }
}
?>
